...
Version 1.1 adds support for multiple contract years, allowing users to view rate data based on when they submitted their solar application (2023, 2024, 2025, or 2026). This addresses the fact that SDGE rate structures vary based on the year customers submitted their Net Billing Tariff application.
...
- Select from 2023 (NBT23), 2024 (NBT24), 2025 (NBT25), or 2026 (NBT26)
- Shows current selection with rate code
- Helper text explains what contract years mean
- Default year is 2025 (most recent)
- Enhanced styling with larger button, shadow, and blue border
